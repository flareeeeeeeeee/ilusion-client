...
import { getUserByToken, register } from "../../../providers/_requests";
          ...
          <div className="position-relative mb-3">
            <input
              ...
              className={clsx(
                "form-control bg-transparent",
                {
                  "is-invalid": formik.touched.password &&
      ...
      <div className="fv-row mb-5">
        ...
        <input
          ...
          className={clsx(
            "form-control bg-transparent",
            {
              "is-invalid": formik.touched.changepassword &&
                formik.errors.changepassword,
            },
            {
              "is-valid": formik.touched.changepassword &&
                !formik.errors.changepassword,
            },
          )}
        />
